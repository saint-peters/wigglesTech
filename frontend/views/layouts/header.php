                        ...
                        <ul class="nav-list">
                            <li><a href="<?=Url::to(['site/index']);?>" class="menu-links">Home</a>
                                <li><a href="<?=Url::to(['about/About']);?>" class="menu-links">About</a>
                                    <li><a href="<?=Url::to(['contacts/contacts']);?>" class="menu-links">Contacts</a>
                                <li><a href="<?=Url::to(['portfolio/portfolio']);?>" class="menu-links">Portfolio</a>
                                    <li><a href="<?=Url::to(['service/service']);?>" class="menu-links">Service</a>
                                            ...
                                            <div class="sub-menu-center-block">
                                                ...
                                                <div class="sub-menu-column">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="minimal-service-onepage.html">Minimal Service</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="sub-menu-section">
                                <div class="container">
                                    <div class="sub-menu-center-block">
                                        ...
                                        <div class="sub-menu-column">
                                            <a href="#"><img src="<?=yii::$app->request->baseUrl;?>/images/banner/header-1.jpg" alt="service" class="img-fluid"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="sub-menu-section">
                            <div class="container">
                                <div class="sub-menu-center-block">
                                    ...
                                    <div class="sub-menu-column">
                                        <a href="#"><img src="<?=yii::$app->request->baseUrl;?>/images/banner/header-2.jpg" alt="service" class="img-fluid"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<li><a href="service/service">enterprise software development</a> </li>
<li><a href="service/service">fullstack web development</a> </li>
<li><a href="service/service">mobile app development</a> </li>
<li><a href="service/service">app migration & legacy mordanisation services</a> </li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<div class="contact-inquiry">
    <div class="contact-info-">
        <div class="contct-heading">WigglesTech Contacts</div>
        ...
        <div class="inquiry-card-nn">
            ...
            <li><i class="fab fa-skype"></i><a href="skype:niwax.company?call" >WigglesTECH.company</a></li>
...
<ul>
<li><a href="service">All services</a> </li>
<li><a href="service">Enterprise Software Development</a> </li>
<li><a href="service">Fullstack Web Development</a> </li>
<li><a href="service">Mobile App Development</a> </li>
<li><a href="service">App Migration & Legacy Mordanisation Services</a> </li>
</ul>
</li>
<ul class="bottom-nav">
<li class="prb">
